...
#define USE_CONTROLLER_FAN
  ...
  // Pin PC15 is E0-STOP connector on SKR Mini E3 V1.2
 ...
 */
#define E0_AUTO_FAN_PIN PC12 // Pin PC12 is PT-DET connector on SKR Mini E3 V1.2
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 8*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
